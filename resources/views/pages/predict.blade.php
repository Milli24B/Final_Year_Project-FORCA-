                    ...
                    <div class="col-md-5">
                        <div class="card h-100">
                            <div class="card-body" style="height: 500px;">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="col-md-12 mt-3">
                                            ...
                                            <select name="category" id=""
                                                class="btn btn-secondary dropdown-toggle w-100 category-item">
                                    ...
                                    <div class="col-md-12 mt-5">
                                        ...
                                        <input type="number" class="form-control input-number proRate" id="rating"
                                            value="1.0" min="1.0" max="5.0" step="0.1">
                                    ...
                                    <div class="col-md-12 mt-3">
                                        ...
                                        <input type="text" class="form-control proCount" id="ratingcount"
                                            placeholder="Rating count" readonly>
                                    </div>
                                    ...
                                    <div class="col-md-12 mt-3">
                                        ...
                                        <input type="text" class="form-control proPrice" id="productprice"
                            ...
                            <div class="card-footer border-0 ">
                                ...
                                <div class="col-md-12">
                                    <button type="button" class="proceed-btn" onclick="validateForm()"
        ...
        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <p style="font-style: italic; color: gray;">The output is only a prediction with a <b>90.2%</b>
                        accuracy
                        !<br>Click <b>PREDICT</b> to countinue.</p>
                </div>
                <div class="modal-footer">
                    <button type="button" class="dismiss-btn" data-bs-dismiss="modal">CLOSE</button>
